...
export default function InventoryCalendar({ tab, date, onSelectDate }) {
  ...
  async function loadAvailableDates() {
    ...
    const set = new Set((data || []).map(d => d.inventory_date));
  ...
  return (
    <div className="relative">
      <button
        onClick={() => setOpen(o => !o)}
        className="border px-4 py-2 rounded bg-white min-w-[150px] text-left"
      >
        ...
        <div className="absolute z-10 mt-2 bg-white border rounded shadow-lg p-3 w-72">
          ...
          <div className="grid grid-cols-7 gap-1 text-center text-sm">
            {cells.map((cellDate, idx) => {
              ...
              const hasData = availableDates.has(dStr);
