  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        className="w-full flex items-center justify-between border rounded-lg px-3 py-2 bg-white text-sm text-left hover:border-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
      >
  ...
  return (
    <div className="p-8 bg-gray-50 min-h-screen flex justify-center">
      <div className="bg-white border rounded-xl shadow-sm p-6 w-full max-w-2xl">
        <h1 className="text-xl font-bold mb-6">New Finished Product</h1>
