        ...
        {tab === "finished" ? (
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-gray-100">
              {loading ? (
                <tr>
                  <td className="px-4 py-4 text-sm text-gray-400" colSpan="6">Loading…</td>
                </tr>
              ) : filteredFinished.length === 0 ? (
                <tr>
                  <td className="px-4 py-8 text-sm text-gray-400 text-center" colSpan="6">
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-gray-100">
              {loading ? (
                <tr>
                  <td className="px-4 py-4 text-sm text-gray-400" colSpan="7">Loading…</td>
                </tr>
              ) : filteredRaw.length === 0 ? (
                <tr>
                  <td className="px-4 py-8 text-sm text-gray-400 text-center" colSpan="7">
                ...
                filteredRaw.map((m) => (
                  <tr key={m.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-4 py-3 text-gray-500">{m.category_id}</td>
